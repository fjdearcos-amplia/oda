...
public class ActivatorTest {
    ...
    public void testStart() throws Exception {
        ...
        PowerMockito.whenNew(GpioDatastreamsFactory.class).withAnyArguments().thenReturn(mockedFactory);
        ...
        PowerMockito.verifyNew(GpioDatastreamsFactory.class)
                .withArguments(eq(mockedGpioService), eq(mockedEventPublisher), any(Executor.class));
